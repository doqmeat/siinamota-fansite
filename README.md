...
- deployed to nekoweb using [deploy2nekoweb](https://github.com/indiefellas/deploy2nekoweb).
- built with [11ty](https://11ty.dev). god bless.
- a siinamota fansite i run :3 the lack of siinamota wikis and archives inspired me to start this site :)
